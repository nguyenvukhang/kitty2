...
default=normal
type=choices
choices=normal,application,alatty,unchanged
The keyboard mode to use when showing keys. :code:`normal` mode is with DECCKM
reset and :code:`application` mode is with DECCKM set. :code:`alatty` is the full
alatty extended keyboard protocol.
'''.format
