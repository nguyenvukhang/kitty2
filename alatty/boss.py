...
class Boss:
    ...
    @ac('misc', '''
        ...
        For example::
            ...
            map alatty_mod+e combine | new_tab | goto_tab -1
        ''')
    ...
    def quit(self, *args: Any) -> None:
        ...
        if num > 0:
            msg = ngettext(
                    'Are you sure you want to quit alatty? It is running the {} program and one other program.',
                    'Are you sure you want to quit alatty? It is running the {} program and {} other programs.', num)
        else:
            msg = _('Are you sure you want to quit alatty? It is running the {} program')
        msg = msg.format(green(active_program or program or 'shell'), num)
        w = self.confirm(msg, self.handle_quit_confirmation, window=tm.active_window, title=_('Quit alatty?'))
    ...
    def set_colors(self, *args: str) -> None:
        ...
        try:
            ...
            return
        c.response_from_alatty(self, self.window_for_dispatch or self.active_window, PayloadGetter(c, payload if isinstance(payload, dict) else {}))
