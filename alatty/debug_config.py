...
def compare_opts(opts: AlattyOpts, global_shortcuts: dict[str, SingleKey] | None, print: Print) -> None:
...
def debug_config(opts: AlattyOpts, global_shortcuts: dict[str, SingleKey] | None = None) -> str:
