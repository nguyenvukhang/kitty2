...
if TYPE_CHECKING:
    from alatty.cli_stub import LastUsedLayoutRCOptions as CLIOptions
...
type=bool-set
default=false
Don't wait for a response from alatty. This means that even if no matching tab is found,
