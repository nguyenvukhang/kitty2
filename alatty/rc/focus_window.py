...
from alatty.fast_data_types import focus_os_window
...
if TYPE_CHECKING:
    from alatty.cli_stub import FocusWindowRCOptions as CLIOptions
...
type=bool-set
default=false
Don't wait for a response from alatty. This means that even if no matching window is found,
