...
from alatty.fast_data_types import ParsedFontFeature
from alatty.fonts import Descriptor, DescriptorVar, DesignAxis, FontSpec, NamedStyle, Scorer, VariableAxis, VariableData, family_name_to_key
from alatty.options.types import Options

if TYPE_CHECKING:
    from alatty.fast_data_types import CTFace
    from alatty.fast_data_types import Face as FT_Face
    ...
    from alatty.fast_data_types import specialize_font_descriptor
    if is_macos:
        from alatty.fast_data_types import CTFace as Face
        from alatty.fonts.core_text import (
            all_fonts_map,
            create_scorer,
            find_best_match,
        ...
        from alatty.fast_data_types import Face
        from alatty.fonts.fontconfig import (
            all_fonts_map,
            create_scorer,
            find_best_match,
            find_last_resort_text_font,
