...
from alatty.fast_data_types import CURSOR_BEAM, CURSOR_BLOCK, CURSOR_HOLLOW, CURSOR_UNDERLINE, NO_CURSOR_SHAPE, Color, Shlex, SingleKey
from alatty.fonts import FontModification, FontSpec, ModificationType, ModificationUnit, ModificationValue
...
@func_with_args('set_background_opacity', 'goto_layout', 'toggle_layout', 'toggle_tab', 'alatty_shell', 'show_alatty_doc', 'set_tab_title', 'push_keyboard_mode')
...
class EasingFunction(NamedTuple):
    ...
    def __repr__(self) -> str:
        ...
        return f'alatty.options.utils.EasingFunction({fields})'
