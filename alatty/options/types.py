...
from alatty.fonts import FontSpec
import alatty.fonts
...
class Options:
    ...
    cursor_blink_interval: typing.Tuple[float, alatty.options.utils.EasingFunction, alatty.options.utils.EasingFunction] = (-1.0, alatty.options.utils.EasingFunction(), alatty.options.utils.EasingFunction())
    cursor_shape: int = 1
    ...
    visual_bell_duration: typing.Tuple[float, alatty.options.utils.EasingFunction, alatty.options.utils.EasingFunction] = (0.0, alatty.options.utils.EasingFunction(), alatty.options.utils.EasingFunction())
    ...
    font_features: typing.Dict[str, typing.Tuple[alatty.fast_data_types.ParsedFontFeature, ...]] = {}
