...
class MacOSIntegration(DesktopIntegration):
    ...
    def notify(self, nc: NotificationCommand, existing_desktop_notification_id: Optional[int]) -> int:
        ...
        # "alatty" as the title. So use a single space for the body in this
        ...
        cocoa_send_notification(
            nc.application_name or 'alatty', str(desktop_notification_id), nc.title, body,
...
class FreeDesktopIntegration(DesktopIntegration):
    ...
    def notify(self, nc: NotificationCommand, existing_desktop_notification_id: Optional[int]) -> int:
        ...
        desktop_notification_id = dbus_send_notification(
            app_name=nc.application_name or 'alatty', app_icon=app_icon, title=nc.title, body=body, actions=actions,
