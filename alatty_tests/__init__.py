...
from alatty.fast_data_types import Cursor, HistoryBuf, LineBuf, Screen, get_options, monotonic, set_options
...
from alatty.window import decode_cmdline, process_remote_print, process_title_from_child
...
class Callbacks:
    ...
    def color_control(self, code, data) -> None:
        from alatty.window import color_control
