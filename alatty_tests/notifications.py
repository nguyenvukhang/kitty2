...
from alatty.notifications import Channel, DesktopIntegration, IconDataCache, NotificationManager, UIState, Urgency
...
def do_test(self: 'TestNotifications', tdir: str) -> None:
    ...
    self.ae(di.notifications, [n('alatty update available!', 'alatty version moose released')])
    activate()
